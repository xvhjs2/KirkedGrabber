...
- Grabbing gecko/firefox based passwords (using the nss3 method)
- Grabbing discord accounts (no billing info and subscription info)
- Grabbing system information and ip address
- Screenshotting
